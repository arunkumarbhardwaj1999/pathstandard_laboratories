  ...
  return (
    <section className="section-padding bg-ps-navy-deep text-white">
      <Container className="max-w-3xl">
        ...
        <h1 className="text-section-title mt-3 text-white">Privacy Policy</h1>
        ...
        <div className="mt-10 space-y-8 text-white/70 leading-relaxed">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">3. Data Retention &amp; Security</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">4. Analytics &amp; Cookies</h2>
            <p className="mt-2">
